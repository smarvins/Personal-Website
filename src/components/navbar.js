...
function Navbar() {
  return (
    <div className="pt-4">
      ...
      <Link to="/" className="font-semibold text-xl p-4 text-gray-200">&lt; steve marvins /&gt;</Link>
      <div className="flex justify-evenly mx-10 mb-5">
        <div className="flex">
          <Link to="/services" className="m-auto pt-2">
            <span className=" animate-ping absolute h-8 w-8 rounded-full md:hover:bg-white opacity-75 mx-6 mt-2"></span>
        ...
        <div className="flex">
          <Link to="/skills" className="m-auto pt-2">
            <span className=" animate-ping absolute h-8 w-8 rounded-full md:hover:bg-white opacity-75 mx-2 mt-2"></span>
            <svg className="w-12 m-auto bg-gray-100 rounded-full p-3 stroke-current text-red-400 sm:text-green-400 md:text-blue-400 lg:text-pink-400 xl:text-teal-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex">
          <Link to="/experience" className="m-auto pt-2">
            <span className=" animate-ping absolute h-8 w-8 rounded-full md:hover:bg-white opacity-75 mx-10 mt-2"></span>
            <svg className="w-12 m-auto bg-gray-100 rounded-full p-3 stroke-current text-red-400 sm:text-green-400 md:text-blue-400 lg:text-pink-400 xl:text-teal-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" />
            </svg>
            <p className="font-light text-xl p-2 text-white">experience</p>
          </Link>
        </div>
